    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers("/task-notifications").permitAll()
                        .requestMatchers("/api/news").permitAll()
                        .requestMatchers("/getChatData").permitAll()
                        .requestMatchers("/fetchNotifications").permitAll()
                        .requestMatchers("/updateStatus").permitAll()
                        .requestMatchers("/listEmployees").permitAll()
                        .requestMatchers("/listEmployeesNoLogin").permitAll()
